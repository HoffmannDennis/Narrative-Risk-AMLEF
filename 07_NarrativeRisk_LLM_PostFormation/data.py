"""Self-contained I/O + on-demand fetchers for the 07_NarrativeRisk_LLM_PostFormation quantlet.
...
def main() -> None:
    ...
    print(f"data.py for 07_NarrativeRisk_LLM_PostFormation (writing to {HERE})")
