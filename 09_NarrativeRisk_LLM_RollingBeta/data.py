"""Self-contained I/O + on-demand fetchers for the 09_NarrativeRisk_LLM_RollingBeta quantlet.
...
def main() -> None:
    ...
    print(f"data.py for 09_NarrativeRisk_LLM_RollingBeta (writing to {HERE})")
