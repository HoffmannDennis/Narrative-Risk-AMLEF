"""Self-contained I/O + on-demand fetchers for the 04_NarrativeRisk_DeltaSeverity quantlet.
...
def main() -> None:
    ...
    print(f"data.py for 04_NarrativeRisk_DeltaSeverity (writing to {HERE})")
