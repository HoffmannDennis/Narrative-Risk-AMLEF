"""Self-contained I/O + on-demand fetchers for the 01_NarrativeRisk_LLM_DisclosureScoring quantlet.
...
def main() -> None:
    ...
    print(f"data.py for 01_NarrativeRisk_LLM_DisclosureScoring (writing to {HERE})")
