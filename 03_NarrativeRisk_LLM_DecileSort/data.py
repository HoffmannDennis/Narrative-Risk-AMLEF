"""Self-contained I/O + on-demand fetchers for the 03_NarrativeRisk_LLM_DecileSort quantlet.
...
def main() -> None:
    ...
    print(f"data.py for 03_NarrativeRisk_LLM_DecileSort (writing to {HERE})")
